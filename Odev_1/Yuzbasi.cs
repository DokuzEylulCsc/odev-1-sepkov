    ...
    class Yuzbasi : Asker
    {
        ...
        public override void AteşEt(List<Asker> düşman)
        {
            if (yaşıyorMu)
            {
                ...
                Console.WriteLine(takım + "Yüzbaşı'sı düşman" + düşman.GetType().Name + "askerine ateş etti");
                streamWriter.WriteLine(takım + "Yüzbaşı'sı düşman" + düşman.GetType().Name + "askerine ateş etti");
                int[] hasar = { 15, 25, 40 };
